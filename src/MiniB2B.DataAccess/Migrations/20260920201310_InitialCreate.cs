        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Header = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ...
                    ShowOnTablet = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomCode1 = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    CustomCode2 = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ImagePath = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    StockQuantity = table.Column<int>(type: "int", nullable: false),
                    CriticalStockLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGridColumns_FieldName",
                table: "ProductGridColumns",
                column: "FieldName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductGridColumns_SortOrder",
                table: "ProductGridColumns",
                column: "SortOrder");
